...
- **CCaaS_GetRepresentativeAvailabilityForConversation**: Returns the queue and service representative availability during an active conversation with a valid conversation ID. Learn more in [CCaaS_GetRepresentativeAvailabilityForConversation](./api/ccaas-get-representative-availability-conversation.md)
- **CCaaS_GetRepresentativeAvailabilityBeforeConversation**: Returns the queue and service representative availability before a conversation with the customer starts. Learn more in [CCaaS_GetRepresentativeAvailabilityBeforeConversation](./api/ccaas-get-representative-availability-before-conversation.md)
