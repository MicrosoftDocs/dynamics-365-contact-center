...
Customer Intent Agent uses the determined intent and interview responses to also improve the quality of generated answers for both Copilot Studio agents and customer service representatives (service representatives or representatives).
...
- In the next customer interaction with a Copilot Studio agent, the Copilot Studio agent can self-service the customer issue with the newly harvested knowledge and intent, and provide a tailored response without the involvement of any representative.
