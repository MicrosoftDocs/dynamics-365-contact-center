...
You can use the `CCaaS_CancelDeliveryTask` API to cancel all pending and future delivery attempts for a contact or chain(account). When a delivery task is canceled, no further attempts are made for the associated contact(s).
