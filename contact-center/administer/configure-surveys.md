...
CSAT scores for conversations appear in the Omnichannel historical analytics report, and for cases they appear in the Customer Service historical analytics report—provided the scores are stored as numeric values in the MCS_CSAT variable.
