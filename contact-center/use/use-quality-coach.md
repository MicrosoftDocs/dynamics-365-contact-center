---
title: Use quality and coaching skill
description: Use the quality and coaching skill to monitor conversation scores, review evaluations, and provide representatives with real-time guidance.
author: Soumyasd27
ms.author: sdas
ms.reviewer: sdas
ms.topic: how-to
...
# Use quality and coaching skill

[!INCLUDE [cc-feature-availability-cc-only](../includes/cc-feature-availability-cc-only.md)]

The quality and coaching skill helps improve service interactions by providing real-time guidance to customer service representatives (service representatives or representatives) and post-conversation insights for supervisors. The skill enables organizations to monitor quality, encourage consistent service behaviors, and take corrective action during and after customer interactions.
...
## Manage quality and coaching skill as a supervisor

The quality and coaching skill enables supervisors to monitor, evaluate, and improve conversation quality through notifications, scoring insights, and detailed evaluations. The feature supports real-time monitoring and post-conversation analysis.
...
## Manage quality and coaching skill as a service representative

The quality and coaching skill provides real-time guidance to help service representatives improve customer interactions as they occur in Copilot Service workspace. The feature enables representatives to receive contextual recommendations and adjust their responses during live conversations.
...
[Configure quality and coaching skill](../administer/configure-quality-coach.md)  
