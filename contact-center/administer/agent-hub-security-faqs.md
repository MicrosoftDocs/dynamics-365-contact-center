...
### Are there any profiling activities based on user data? If yes, will the AI system profile individuals or groups?
...
### Do you expect the AI system to generate insights? If yes, what kind of insights?
...
### What data sources will the AI system use?
CEP cases data.
