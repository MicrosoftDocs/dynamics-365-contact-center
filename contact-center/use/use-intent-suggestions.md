...
The agent also provides next best actions in the case experience, so you can take recommended actions&mdash;such as reviewing a response or resolving a case&mdash;directly from the Copilot pane.
