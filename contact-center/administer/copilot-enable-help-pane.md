...
1. In the **Instructions** field, enter the guidance you want Copilot to follow when generating responses. This field supports up to 5,000 characters. For example, you could input instructions like the following details:<br>
...
1. Select **Save**. The instructions are applied to all responses generated by Copilot when representatives use the **Ask a question** feature.
...
If you enabled the Copilot immersive experience, enhanced features, such as inline comments, are always available. If you want to allow enhanced features in the Copilot side pane, on the **Customer Support** page, on the **Overview** tab, select **Allow enhanced features**.
