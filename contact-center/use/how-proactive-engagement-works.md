...
## Representative-led preview dial
...
## Representative-led predictive and progressive
...
1. A notification appears on the representative desktop with the proactive engagement name and description, letting them know that they're going to be included in a running proactive engagement.
...
1. If the representative accepts the call, they are placed on the call to begin engaging with the customer.
...
1. The service representative can mark that a customer requested no further outreach by selecting the out-of-box **Do not contact** disposition code.
1. When this disposition code is selected, the contact is added to the local do-not-contact table and doesn't receive further outbound calls.
