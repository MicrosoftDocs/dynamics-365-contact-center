...
This article walks you through creating a custom Azure agent and integrate with Dynamics 365 Contact Center.
...
Run: dotnet run (agent runs on <https://localhost:3979> and <http://localhost:3978>)
...
**// Add Dynamics middleware - THIS IS CRITICAL**
...
private async Task OnEventActivityAsync(ITurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)

{

// Handle omnichannelSetContext event

if (turnContext.Activity.Name == " <span class="mark"></span>omnichannelSetContext")
...
// Bridge message so it's visible to both customer and agent
...
[Enable Agent Context for Azure Agents](https://learn.microsoft.com/en-us/dynamics365/customer-service/develop/enable-bot-context-azure)

## Integrate with Dynamics 365

Now register your agent in Azure and connect it to the channel in Dynamics 365 Contact Center. Learn more in [Integrate Azure Agents](/dynamics365/customer-service/administer/configure-bot-azure#integrate-azure-agents-with-contact-center)
