...
You can provide custom instructions to guide how Copilot generates responses when service representatives use the **Ask a question** feature. On the **Copilot for questions and email** page, in the **Custom instructions** field under **Ask a question**, enter the guidance you want Copilot to follow when generating responses, and then select **Save**. The instructions are applied to all responses generated by Copilot when representatives use **Ask a question**.

Custom instructions can provide guidance on tone and style. They can also include formatting preferences, escalation guidance, compliance reminders, and organization-specific terminology. The **Custom instructions** field supports up to 5,000 characters.
