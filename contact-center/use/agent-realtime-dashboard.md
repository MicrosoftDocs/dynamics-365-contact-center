...
To view the report in Customer Service worskpace, administrators with the Omnichannel agent role enable must enable the realtime bot dashboard in **Customer Service admin center** > **Insights** **Productivity** > **Real-time Analytics**.
