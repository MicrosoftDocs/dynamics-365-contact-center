...
- In the rich text editor, select **Keep it**. You see the draft in the rich text editor that you can use as-is or further edit before sending it to the customer.
