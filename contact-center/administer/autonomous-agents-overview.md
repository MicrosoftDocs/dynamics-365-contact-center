...
Quality Evaluation Agent helps generate autonomous and AI-assisted assessments of customer interactions across cases and conversations, using an evaluation framework defined by supervisors. Supervisors can create an evaluation criteria, evaluation plan, and make use of the evaluations generated by the AI agent to improve customer interactions. Learn more in [Manage Quality Evaluation Agent (preview)](manage-quality-evaluation-agent.md#manage-quality-evaluation-agent-preview).
