...
description: Learn how Copilot selects a language for responses, case summaries, and conversation summaries.
author: gandhamm
ms.author: mgandham
...
Copilot can generate answers, case summaries, and conversation summaries in [multiple languages](/dynamics365/customer-service/implement/international-availability?context=/dynamics365/contact-center/context/implement-context) for customer service representatives (service representatives or representatives).
...
## Review language support scenarios
...
| The UI language is set to Spanish. The knowledge articles are in English only. The service representative asks a question in Spanish. | No response is generated. |
