...
You can provide custom instructions to guide how Copilot generates responses when service representatives use the **Ask a question** feature. On the **Copilot for questions and email** page, in the **Custom instructions** field under **Ask a question**, enter the guidance you want Copilot to follow when generating reponses, and then select **Save**. The instructions are applied to all responses generated by Copilot when representatives use **Ask a question**.

Custom instructions can include guidance such as tone and style requirements, formatting preferences, escalation guidance, compliance or policy reminders, and organization-specific terminology. The **Custom instructions** field supports up to 5,000 characters.

To improve the quality of Copilot responses, keep the instructions clear and concise, and update instructions if your organization changes its policies. Perodically review Copilot responses to ensure they align with your organization's expectations.
