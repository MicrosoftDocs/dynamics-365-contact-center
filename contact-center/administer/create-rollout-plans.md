...
1. In the site map of Copilot Service admin center, select **Home**, and then select **Open** in **Agent hub**.
...
- **Schedule**: Set a future date and time for your rollout plan to be enabled automatically.
