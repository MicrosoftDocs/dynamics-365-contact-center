 ...
 **Use prompts**
  ...
  **Use Copilot recommended email templates**
  ...
  > [!NOTE]
  > You can use Copilot recommended email templates only for when there isn't any text already present in the email editor. If there's already text present in the editor, Copilot generates an email draft without using an email template.
