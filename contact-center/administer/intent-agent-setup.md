...
1. To add behavior after intent determination and interview completion, select **Add a condition**, and set it to **Global.IntentInterviewComplete is equal to true**,  **Or** **Global.IntentInterviewIncomplete is equal to true**.
