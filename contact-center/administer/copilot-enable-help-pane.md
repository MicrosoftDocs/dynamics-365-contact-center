...
1. Select **Save**. The instructions are applied to all responses generated by Copilot when representatives use **Ask a question**.
...
Select **Let representatives translate responses** to allow service representatives to translate responses generated by Copilot to their preferred language. Representatives can choose from a list of languages that your organization added to Dynamics 365 Customer Service.
