---
title: Transfer conversations from customer service representatives to AI agents
description: Learn how a customer service representative can transfer a conversation back to an AI agent.
author: gandhamm
ms.author: mgandham
...
- Create two AI agents that reside in two queues
- Create two AI agents that reside in the same queue

### Two AI agents in two queues
...
2. The first AI agent (Agent A) that has the highest capacity accepts the conversation.
...
6. The service representative has finished delivering support and wants to hand off the conversation to a second AI agent (Agent B), which resides in the same queue.
7. The service representative is disconnected from the conversation, and the conversation is routed to AI agent B.
