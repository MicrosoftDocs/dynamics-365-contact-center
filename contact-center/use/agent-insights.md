...
The Agent insights dashboard equips supervisors with real-time visibility into key performance indicators and operational trends regarding their AI agents. This information enables them to make confident and data-driven decisions throughout the autonomous transformation journey.
...
| Metric                   | Definition                                                                                                         |
|--------------------------|--------------------------------------------------------------------------------------------------------------------|
| Active conversations     | The total number of conversations that are active.                                                   |
| Closed conversations     | The total number of conversations that were closed or abandoned. |
...
| Quality score            | The score that evaluates how well a conversation met defined quality standards.|
| Sentiment score          | The customer sentiment of the communication between the user and customer generated by machine learning. |
...
| | Conversation count                    | The total number of conversations that Customer Intent Agent was automatically connected to or added to after the conversation started. |
...
| | Cases enriched by AI     | The number of cases that Case Management Agent enriched autonomously. |
| | Emails sent or drafted by AI agent    | The number of emails sent or drafted autonomously or with AI assistance. |
| Quality Evaluation Agent    | | |
| | Quality evaluations                    | The total number of evaluations where evaluations are performed. |
|| Quality score                            | The score that indicates how well the defined quality standards are met. |
|| Evaluations below quality thresholds     | The number of evaluations that didn't reach the target evaluation threshold.|
